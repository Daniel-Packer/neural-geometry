# Using the example notebook from: https://jax.readthedocs.io/en/latest/notebooks/neural_network_with_tfds_data.html
...
def load_data():
    ...
    return train_data, test_data, num_pixels, num_labels
...
def train(params, num_epochs, batch_size, train_data, test_data, num_pixels, num_labels, lr):
